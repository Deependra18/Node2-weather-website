...
{
const url ='https://api.mapbox.com/geocoding/v5/mapbox.places/'+encodeURIComponent(address)+'.json?access_token=pk.eyJ1IjoiZGVlcGVuZHJhMTgiLCJhIjoiY2tjYWdma3BzMWVuZDJ3bnhqdnBmbjhxNyJ9.gDjg-vefeUDRCyeRx3ijwA';
request({url,json:true},(error,{body})=>{
    //while wifi is not working
    if(error) 
    {
